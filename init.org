...
This function allows the use of counsel-linux-app function from your window manager or linux command line. To do this, create a script that contains the following command, which will open the emacs frame as suggested in the function below. 

#+BEGIN_SRC emacs-lisp :tangle no
emacsclient -e "(emacs-run-launcher)"
#+END_SRC

This was taken from Reddit (http://t.ly/BTIb) [[http:://t.ly/BTlb][Reddit]]
